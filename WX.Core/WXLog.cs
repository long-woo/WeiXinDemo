...
namespace WX.Core
{
    public class WXLog
    {
        ...
        {
            string htmlTemp = string.Format(@"=========日志信息========\r\n{0}", text); //string.Format("<!DOCTYPE html><html lang=\"zh-cn\"><head><meta charset=\"utf-8\"/><title>微信日志记录</title></head><body>{0}</body></html>", text);
            ...
            string logPath = /*@"C:\MicroChat\Log";*/ HttpContext.Current.Server.MapPath(string.Format("~/{0}/{1}", foldName, targetName));
